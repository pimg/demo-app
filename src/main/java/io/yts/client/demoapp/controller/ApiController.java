...
import io.yts.client.demoapp.service.composites.CreditService;
...
public class ApiController {
	...
	public Mono<TransactionsPageDTO> getTransactions(@PathVariable("userId") UUID userId, @PathVariable("accountId") UUID accountId) {
		return accountService.getTransactions(userId, accountId, null);
	}

	@GetMapping("/transactions/{userId}/{accountId}/report")
	public Mono<CreditReport> getCreditReport(@PathVariable("userId") UUID userId, @PathVariable("accountId") UUID accountId) {
		return creditService.calculateCreditReport(userId, accountId);
	}
}
